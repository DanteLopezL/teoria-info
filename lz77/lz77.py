...
ruta_archivo = "/content/Pulcino_pio_prueba.txt"
archivo_salida = "/content/resultado_compresion.txt"

matricula = 2078068
snm = suma_digitos(matricula)
print(f"La suma de los dígitos de {matricula} es: {snm}")
