...
Original file is located at
    https://colab.research.google.com/drive/1R3SWAJ80jwIo6hEWfOEWhGOQjEVm1c9o
"""
...
def compresion_lz77(ruta_archivo, tam_ventana_historia, tam_ventana_futura, archivo_salida):
    ...
    with open(archivo_salida, 'w') as salida:
        while posicion_actual < len(datos):
            ...
            for i in range(len(ventana_historia)):
                longitud = 0
                while (i + longitud < len(ventana_historia) and
                       longitud < len(ventana_futura) and
                       ventana_historia[i + longitud] == ventana_futura[longitud]):
                    longitud += 1
            ...
            datos_comprimidos.append((desplazamiento_coincidencia, longitud_coincidencia, siguiente_caracter))
            ...
            salida.write(f"  Desplazamiento: {desplazamiento_coincidencia}, Longitud: {longitud_coincidencia}, Caracter: '{siguiente_caracter}'\n\n")

            # Avanza A la posición actual
            posicion_actual += longitud_coincidencia + 1 if siguiente_caracter else longitud_coincidencia
...
## EJECUTABLE
resultado = compresion_lz77(ruta_archivo, tam_ventana_historia, tam_ventana_futura, archivo_salida)
